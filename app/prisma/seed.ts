...
const badges = [
  ...
  },
  {
    ...
    tier: 'Silver',
    iconUrl: 'https://api.dicebear.com/9.x/icons/svg?seed=generous-heart',
  ...
  },
  {
    ...
    color: 'bg-green-100 text-green-800',
    tier: 'Gold',
    iconUrl: 'https://api.dicebear.com/9.x/icons/svg?seed=community-builder',
    criteria: { followers: 100 },
  },
  {
    id: 'first-win',
    name: 'First Win',
    description: 'Won your first giveaway',
    color: 'bg-yellow-100 text-yellow-800',
    tier: 'Bronze',
    iconUrl: 'https://api.dicebear.com/9.x/icons/svg?seed=first-win',
    criteria: { wins: 1 },
  },
  {
    id: 'experienced-giver',
    name: 'Experienced Giver',
    description: 'Created 5 giveaways',
    color: 'bg-blue-100 text-blue-800',
    tier: 'Silver',
    iconUrl: 'https://api.dicebear.com/9.x/icons/svg?seed=experienced-giver',
    criteria: { giveaways: 5 },
  },
  {
    id: 'dedicated-helper',
    name: 'Dedicated Helper',
    description: 'Made 25 contributions to help requests',
    color: 'bg-indigo-100 text-indigo-800',
    tier: 'Gold',
    iconUrl: 'https://api.dicebear.com/9.x/icons/svg?seed=dedicated-helper',
    criteria: { contributions: 25 },
  },
];
