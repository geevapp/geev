        ...
        <main className="container max-w-3xl mx-auto px-4 py-6">
          ...
          <div className="space-y-4">
            {posts.map((post) => (
              <Card
                key={post.id}
                className="overflow-hidden bg-white dark:bg-[#101828] border-gray-200 dark:border-[#1E2939]"
              >
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge
                      variant={
                        post.type === "giveaway" ? "default" : "secondary"
                      }
                      className={
                        post.type === "giveaway"
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-[#1E2939]">
                    <div className="flex items-center gap-4">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-500 dark:text-[#6A7282]"
                      >
