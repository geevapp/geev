...
// Skip these tests in mock mode since they require a real database
const describePrisma =
  process.env.MOCK_DB === "true" ? describe.skip : describe;

describePrisma("Prisma", () => {
  ...
  it("should count related posts and comments correctly", async () => {
    const user = await prismaExtended.user
