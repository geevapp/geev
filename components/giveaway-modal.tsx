...
export function GiveawayModal({ draftId }: GiveawayModalProps) {
  ...
  const isFormValid = 
    ...
    category.trim() !== '' &&
    parseInt(maxWinners) >= 1 && parseInt(maxWinners) <= 100 &&
    ...
    <Dialog open={showGiveawayModal} onOpenChange={setShowGiveawayModal}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              <Label htmlFor="maxWinners" className={cn(touched.maxWinners && errors.maxWinners && "text-red-500")}>Max Winners *</Label>
              <Input
                id="maxWinners"
                type="number"
                placeholder="1"
                ...
                onChange={(e) => {
                  ...
                  if (touched.maxWinners) validateField('maxWinners', e.target.value)
                }}
                onBlur={() => handleBlur('maxWinners', maxWinners)}
                className={cn(touched.maxWinners && errors.maxWinners ? "border-red-500 focus-visible:ring-red-500" : touched.maxWinners && !errors.maxWinners && maxWinners ? "border-green-500 focus-visible:ring-green-500" : "")}
              />
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          ...
          <Button
            ...
            className={cn(
              "w-full sm:w-auto",
              isFormValid && !isLoading ? "bg-orange-600 hover:bg-orange-700" : ""
            )}
          >
